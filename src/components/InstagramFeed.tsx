...
export function InstagramFeed({
  ...
  return (
    <div className="w-full rounded-2xl border border-[#d4a017]/20 bg-[#0d2818]/80 backdrop-blur-sm overflow-hidden">
      {/* Profile header */}
      <div className="flex flex-wrap items-center gap-4 sm:gap-6 p-6 border-b border-[#d4a017]/10">
        <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-[#d4a017]/30 shrink-0 bg-[#0a1f0a]">
        ...
        {profileUrl && (
          <Link
            ...
            className="flex items-center gap-2 px-6 py-2.5 rounded-lg bg-[#d4a017] text-[#0a0a0a] font-semibold text-sm hover:bg-[#e8c547] transition-colors shrink-0"
          >
        ...
        {placeholderImages.map((src, i) => {
          ...
          return (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="relative flex-shrink-0 w-[200px] sm:w-[240px] aspect-square rounded-xl overflow-hidden border border-[#d4a017]/20 snap-center group"
            >
              <Image
                src={src}
